...
- Added `JobCancel` and `JobCancelTx` to the `Client` to enable cancellation of jobs. [PR #141](https://weavelab.xyz/river/pull/141) and [PR #152](https://weavelab.xyz/river/pull/152).
